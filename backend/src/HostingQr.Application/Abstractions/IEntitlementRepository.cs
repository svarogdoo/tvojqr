...
public interface IEntitlementRepository
{
    ...
    Task<bool> UpsertAsync(Guid userId, string tier, bool isActive, DateTimeOffset? endsAt, bool grantedManually = false, CancellationToken cancellationToken = default);
}
